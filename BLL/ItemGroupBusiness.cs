...
namespace BLL
{
    public partial class ItemGroupBusiness : IItemGroupBusiness
    {
        ...
        public List<ItemGroupModel> GetData()
        {
            ...
            var lstParent = allItemGroups.Where(ds => ds.category_id == null).OrderBy(s => s.seq_num).ToList();
        ...
        {
            var lstChilds = lstAll.Where(ds => ds.category_id == node.category_id).ToList();
